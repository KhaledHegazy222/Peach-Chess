...
std::set<std::pair<Position,Position>> Knight::getLegalMoves(Board& board) {
...
std::set<Position> Knight::attack(Board& board) {
...
void Knight::render(SDL_Rect* src, SDL_Rect* dest) {

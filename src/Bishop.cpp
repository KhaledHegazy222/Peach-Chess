...
std::set<std::pair<Position, Position>> Bishop::getLegalMoves(Board& board) {
...
std::set<Position> Bishop::attack(Board& board) {
...
void Bishop::render(SDL_Rect* src, SDL_Rect* dest) {
